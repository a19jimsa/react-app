    ...
    return (
      <div className="boxBackground">
        <DialogBox>
          ...
          <AwesomeButton onPress={this.handleCreateThread}>
            Skapa tråd
          </AwesomeButton>
        </DialogBox>
      </div>
      ...
      <div>
        {this.state.updated ? (
          <div className="loading">
            <Grid color="orange" height={150} width={150} />
          </div>
        ) : (
          ""
        )}
        <div className="header">
          <AwesomeButton type="primary" onPress={this.handleShow}>
            Skapa ny tråd
          </AwesomeButton>
          {this.state.show ? this.drawBox() : ""}
          <div>
            Sök trådar:{" "}
            <input type="text" onChange={this.filterThreads}></input>
          </div>
        </div>
        <table>
          <thead>
